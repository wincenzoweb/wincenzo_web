...
import { getSubscriber, openAddModal } from "../../../store/features/inquiry";
...
const SubscriberPage = () => {
  ...
  const { subscriber } = useSelector((state) => state.inquiry);
  ...
  return (
    <div>
      ...
      {isLoaded && filler === "list" && (
        <TableLoading count={subscriber?.length} />
      )}

      {filler === "list" && !isLoaded && (
        <div>
          <SubscriberList subscriber={subscriber} />
        </div>
      )}
      {/* <AddInquiry />
      <EditInquiry /> */}
