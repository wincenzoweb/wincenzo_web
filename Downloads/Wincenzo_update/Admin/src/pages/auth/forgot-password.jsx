...
import Logo from "@/assets/images/logo/Wincenzo_logo.png";
import Illustration from "@/assets/images/auth/Site Stats-pana.svg";
    ...
    <div className="loginwrapper">
      <div className="lg-inner-column">
        <div className="left-column relative z-[1]">
          <div className="max-w-[200px] pt-10 ltr:pl-20 rtl:pr-20">
            <Link to="/">
              <img src={isDark ? LogoWhite : Logo} alt="" className="mb-5" />
            </Link>

          </div>
          <h4 className="ltr:pl-20">
            Unlock your Project
        ...
        <div className="right-column relative">
          <div className="inner-content h-full flex flex-col bg-white dark:bg-slate-800">
            ...
            <div className="auth-footer text-center">
              Copyright {dayjs().format("YYYY")}, Wincenzo All Rights Reserved.
            </div>
          </div>
        </div>
      </div>
