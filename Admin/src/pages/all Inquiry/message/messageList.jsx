...
import { deleteMessage, getAllmessage, updateData } from "../../../store/features/inquiry";
...
const MessageList = ({ messages }) => {
  ...
  const handleExport = () => {
    const dataToExport = messages.map(messageItem => ({
      "Email": messageItem.email,
      "Description": messageItem.message,
      "Date": dayjs(messageItem.createdAt).format("DD/MM/YYYY"),
    }));
